...
class BooksApp extends React.Component {
  ...
  render() {
    console.log("all books from api", this.state.books);
    console.log("books cuurently reading", this.state.currentlyReading);
    console.log("books want to read", this.state.wantToRead);
    console.log("books read", this.state.read);
